...
export const shipmentFulfillmentStateMachine: StateMachineDefinition<ShipmentFulfillmentMachineStatus> = {
  ...
  transitions: [
    { from: 'confirmed', to: 'allocated', action: 'allocate', allowedActors: ['system', 'staff', 'admin'], guardDescription: 'Inventory allocated for shipment' },
    ...
    { from: 'shipped', to: 'in_transit', action: 'mark_in_transit', allowedActors: ['system', 'staff', 'admin'], guardDescription: 'Carrier confirms in transit' },
    { from: 'in_transit', to: 'delivered', action: 'deliver', allowedActors: ['system', 'staff', 'admin'], guardDescription: 'Carrier confirms delivery' },
