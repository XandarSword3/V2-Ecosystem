...
async function run() {
    ...
    try {
        ...
        // (This helps if migrations try to use auth.uid() in VIEW definitions or Function defaults that get evaluated)
        try {
            await client.query(`
        ...
        for (const file of files) {
            ...
            try {
                ...
                failCount++;
                // Rollback any open transaction from the failed migration
