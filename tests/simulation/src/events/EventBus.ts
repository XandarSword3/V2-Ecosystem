...
export const EventTypes = {
  ...
  RESTAURANT_RESERVATION_MADE: 'RESTAURANT_RESERVATION_MADE',
  ...
  POOL_BRACELET_ISSUED: 'POOL_BRACELET_ISSUED',
  ...
  CHALET_BOOKED: 'CHALET_BOOKED',
  CHALET_BOOKING_CANCELLED: 'CHALET_BOOKING_CANCELLED',
  CHALET_CHECKED_IN: 'CHALET_CHECKED_IN',
  CHALET_CHECKED_OUT: 'CHALET_CHECKED_OUT',
  CHALET_ADD_ON_PURCHASED: 'CHALET_ADD_ON_PURCHASED',
  CHALET_CREATED: 'CHALET_CREATED',
  CHALET_UPDATED: 'CHALET_UPDATED',
  CHALET_DELETED: 'CHALET_DELETED',
  CHALET_PRICE_RULE_CREATED: 'CHALET_PRICE_RULE_CREATED',
  
  // Snack Bar
  SNACK_MENU_BROWSED: 'SNACK_MENU_BROWSED',
  SNACK_ORDER_PLACED: 'SNACK_ORDER_PLACED',
  SNACK_ORDER_PREPARED: 'SNACK_ORDER_PREPARED',
  SNACK_ORDER_DELIVERED: 'SNACK_ORDER_DELIVERED',
