-- Fix create_order_customization_snapshot to include tenant_id and property_id in order_customizations insert
-- The function was missing these required columns when inserting into order_customizations
