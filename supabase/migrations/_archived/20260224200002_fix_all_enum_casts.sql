...
BEGIN
  ...
  INSERT INTO chalet_bookings (
    ...
    COALESCE(p_booking->>'status', 'pending')::booking_status,
    COALESCE(p_booking->>'payment_status', 'pending')::payment_status,
    COALESCE(p_booking->>'payment_method', 'cash')::payment_method,
