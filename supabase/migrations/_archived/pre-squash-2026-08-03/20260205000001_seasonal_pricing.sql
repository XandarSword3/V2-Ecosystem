...
CREATE TABLE IF NOT EXISTS seasonal_pricing_rules (
    ...
    applicable_to TEXT[] NOT NULL DEFAULT ARRAY['accommodation'],
...
VALUES 
    ('Summer Peak Season', '07-01', '08-31', 1.40, ARRAY['accommodation', 'capacity_windows'], 10, true),
    ('Easter Holiday', '04-01', '04-15', 1.25, ARRAY['accommodation', 'capacity_windows', 'menu_service'], 15, true),
    ('Christmas & New Year', '12-20', '01-05', 1.50, ARRAY['accommodation', 'capacity_windows', 'menu_service'], 20, true),
    ('Spring Break', '03-15', '03-31', 1.20, ARRAY['accommodation', 'capacity_windows'], 8, true),
    ('Winter Low Season', '01-15', '02-28', 0.85, ARRAY['accommodation'], 5, true),
    ('Autumn Special', '10-01', '10-31', 0.90, ARRAY['accommodation', 'capacity_windows'], 5, true)
...
-- record_booking_price fires on transactions (time_exclusive_reservation engine)
...
-- base_price and pricing_rules_applied are stored in transactions.metadata
-- No separate columns needed; the blocks below are no-ops.
DO $$ BEGIN NULL; END $$;

-- Trigger on transactions instead of chalet_bookings
DROP TRIGGER IF EXISTS trigger_record_booking_price ON transactions;
