-- Fix process_customization_inventory_safe to use FIFO batch deduction
-- The function was updating inventory_items directly instead of deducting from inventory_batches
