-- Migration: Adjust Loyalty Points by Account ID Atomically
-- Date: 2026-02-13
-- Purpose: Atomic point adjustments by account_id to prevent lost updates

CREATE OR REPLACE FUNCTION adjust_loyalty_points_by_account_atomic(
    p_account_id UUID,
    p_points INTEGER,
