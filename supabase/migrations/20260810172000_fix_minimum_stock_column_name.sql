-- Fix process_customization_inventory_safe to use correct column name
-- The inventory_items table uses 'min_stock_level' but the function was using 'minimum_stock'

-- This is a targeted fix using ALTER FUNCTION to change the specific line
-- We need to recreate the function with the correct column name
