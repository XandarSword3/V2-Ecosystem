-- =============================================
-- Standalone Schema Repair Migration
-- Creates only the gap_remediation tables, skipping problematic earlier migrations
-- =============================================
...
-- 4. User 2FA columns (safe, idempotent)
DO $$
BEGIN
...
-- 5. Enable RLS with permissive policies for demo
