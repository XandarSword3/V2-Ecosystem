    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center py-10">
        <Container size="sm" className="w-full">
          ...
          <Link href={`/${propertySlug}/${slug}`} className="block w-full py-3 bg-primary text-white font-semibold rounded-xl hover:bg-primary/90 transition-colors text-center">
            Back to {moduleName}
          </Link>
          </div>
        </Container>
