...
export default function ModulePage() {
  ...
  // Route to the correct staff dashboard based on engine_type (the
  // canonical field). template_type is legacy and must not be used here —
  // see the note on ModuleData above.
