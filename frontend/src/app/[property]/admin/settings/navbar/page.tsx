    ...
    const updateLink = (index: number, field: keyof NavLink, value: string | boolean) => {
        ...
        if (field === 'moduleSlug' && value) {
            ...
            if (module) {
                ...
                newLinks[index].href = `/${module.slug}`; // stored without property prefix; Header adds it at render time
            }
        }
                                    ...
                                    {navbar.links.map((link, idx) => (
                                        ...
                                        >
                                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                                                ...
                                                <div className="space-y-1">
                                                    <label className="text-[10px] font-bold text-slate-400 uppercase">{link.type === 'module' ? 'Path (property/ added at runtime)' : 'URL / Path'}</label>
                                                    <Input
                                                        value={link.href}
