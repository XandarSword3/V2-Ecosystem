...
export default function DynamicModuleDashboard() {
  ...
  const renderMenuServiceDashboard = () => (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Link href={`/${propertySlug}/admin/${moduleSlug}/menu`}>
      ...
      <Link href={`/${propertySlug}/admin/${moduleSlug}/categories`}>
        <Card className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer h-full">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Link href={`/${propertySlug}/admin/${moduleSlug}/orders`}>
        <Card className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer h-full">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
  ...
  const renderBookingDashboard = () => (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Link href={`/${propertySlug}/admin/${moduleSlug}/bookings`}>
        <Card className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer h-full">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Link href={`/${propertySlug}/admin/${moduleSlug}/pricing`}>
        <Card className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer h-full">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Link href={`/${propertySlug}/admin/${moduleSlug}/calendar`}>
        <Card className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer h-full">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">View bookings & block dates</p>
          </CardContent>
        </Card>
      </Link>
    </div>
  ...
  const renderSessionDashboard = () => (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Link href={`/${propertySlug}/admin/${moduleSlug}/sessions`}>
        <Card className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer h-full">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Link href={`/${propertySlug}/admin/${moduleSlug}/tickets`}>
        <Card className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer h-full">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
  ...
  const renderPlatformEntitlementDashboard = () => (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Link href={`/${propertySlug}/admin/${moduleSlug}/plans`}>
        <Card className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer h-full">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Link href={`/${propertySlug}/admin/${moduleSlug}/tenants`}>
        <Card className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer h-full">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
