...
export default function LiveUsersPage() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      console.warn('[Admin Live Users] No auth token available - admin socket connection skipped');
      return;
    }
    ...
    socket.on('connect_error', (error) => {
      console.error('[Admin Live Users] Socket connection error:', error.message);
    });
