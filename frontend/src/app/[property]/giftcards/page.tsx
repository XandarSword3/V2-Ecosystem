      ...
      <div className="relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
            ...
            Redeemable for pool access, accommodations, dining, and more.
          </p>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            rows={3}
                            placeholder="Happy Birthday! Hope you enjoy a relaxing day at our property..."
                  ...
                  {step === 'success' && purchasedCard && (
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row justify-center gap-3">
                        ...
                        {isAuthenticated ? (
                          <Link href={`/${propertySlug}/account/giftcards`}>
                            <Button>View My Gift Cards</Button>
                          </Link>
                        ) : (
                          <Link href={`/login?redirect=/${propertySlug}/account/giftcards`}>
