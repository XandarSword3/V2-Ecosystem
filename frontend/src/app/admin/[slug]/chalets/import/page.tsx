...
interface Chalet extends Record<string, unknown> {
  name: string;
  description?: string;
  maxGuests: number;
  bedrooms?: number;
...
export default function ChaletImportPage() {
  ...
  return (
    <ImportWizard<Chalet>
      title="Import Chalets"
      parseEndpoint="/chalets/import/parse"
      commitEndpoint="/chalets/import/commit"
      llmPlaceholder={`Paste your chalet/accommodation listings here. Examples:
