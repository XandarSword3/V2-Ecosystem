...
export default function DynamicCapacityPage() {
  ...
  const resetCurrent = async () => {
    ...
    try {
      ...
      toast.success('Current capacity reset to 0');
    } catch (error) {
  ...
  return (
    <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">{currentModule.name} Capacity</h1>
          <p className="text-slate-500 dark:text-slate-400">Manage capacity settings and thresholds</p>
        </div>
      ...
      {loading ? (
        ...
        <>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Current Status</h3>
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                    ...
                    {isFull ? 'Full' : isWarning ? 'Near Capacity' : 'Available'}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-6 mb-6">
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm text-slate-500 dark:text-slate-400">Current Occupancy</span>
          ...
          <motion.div variants={fadeInUp}>
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-6">Capacity Settings</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">Total allowed guests at any time</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">Current number of guests</p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-slate-500 mt-1">Show warning when capacity reaches this %</p>
                  </div>
                </div>
