...
export default function RestaurantCartPage() {
  ...
  const orderTypeOptions = [
    { value: 'dine_in', label: t('dineIn'), icon: Store, description: 'Enjoy at our restaurant' },
    { value: 'takeaway', label: t('takeaway'), icon: ShoppingCart, description: 'Pick up when ready' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50/50 to-rose-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-8">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <Link href="/restaurant" className="inline-flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-orange-600 dark:hover:text-orange-400 transition-colors mb-4">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 mt-1">
                Complete your order • {restaurantItems.length} {restaurantItems.length === 1 ? 'item' : 'items'}
              </p>
            </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">{restaurantItems.length} items • {formatCurrency(subtotal, currency)}</p>
                  </div>
                </div>
                  ...
                  >
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        ...
                        <p className="text-sm text-slate-500 mt-1 text-center">Pay when you receive your order</p>
                      </motion.button>
