...
export function formatCurrency(amount: number | string | undefined | null, currency: Currency | string = 'USD'): string {
  ...
  const convertedAmount = numAmount * (exchangeRates[currency as Currency] || 1);
